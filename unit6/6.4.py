...
def main():
    ...
    background = Image.open(r'C:\Users\Liam\PycharmProjects\pythonProject\venv\next_course\background.jpg')
    ...
    draw.line(first, fill='black')
    draw.line(second, fill='black')

    # Fill the body of the cow with white color
